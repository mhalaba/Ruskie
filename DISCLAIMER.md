...
Domyślnie `coord_precision` to `city` lub `garrison_town`. Zaokrąglenie współrzędnych: 2 miejsca dziesiętne dla miast (~1 km), maksymalnie 3 dla osiedli garnizonowych (~100 m). Nie uśredniamy rozbieżnych lokalizacji.
